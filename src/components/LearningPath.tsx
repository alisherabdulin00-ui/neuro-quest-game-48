            ...
            >
              ...
              >
                ...
                <div className={`
                  ...
                  ${isCompleted 
                    ? 'bg-indigo-600 text-white border-[3px] border-indigo-700 shadow-[4px_4px_0px_0px] shadow-indigo-700' 
                    : unlocked
                    ? 'bg-indigo-600 text-white border-[3px] border-indigo-700 shadow-[4px_4px_0px_0px] shadow-indigo-700'
                    : 'bg-indigo-300 text-indigo-100 opacity-60 border-[3px] border-indigo-400 shadow-[4px_4px_0px_0px] shadow-indigo-400'
                  }
                `}>
