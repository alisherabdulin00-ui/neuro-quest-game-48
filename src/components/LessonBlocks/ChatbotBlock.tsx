        ...
        <div className="w-full max-w-2xl space-y-4">
          ...
          <div className="flex space-x-4">
            <input
              ...
              className="flex-1 px-6 py-4 text-lg font-medium bg-white border-2 border-gray-300 rounded-2xl shadow-[0px_4px_0px_0px] shadow-gray-300 focus:outline-none focus:border-indigo-400 focus:shadow-indigo-300 focus:shadow-[0px_4px_0px_0px] transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed placeholder:text-gray-400"
            />
            <Button 
              onClick={() => handleSend()}
              disabled={!inputValue.trim() || isGenerating || (hasTask && attemptsUsed >= maxAttempts)}
              className="bg-indigo-500 hover:bg-indigo-600 text-white px-6 py-4 text-lg font-bold rounded-2xl border-2 border-indigo-400 shadow-[0px_4px_0px_0px] shadow-indigo-400 hover:shadow-[0px_2px_0px_0px] hover:shadow-indigo-400 active:shadow-[0px_0px_0px_0px] active:shadow-indigo-400 transition-all duration-150 hover:translate-y-[2px] active:translate-y-[4px] disabled:opacity-50 disabled:cursor-not-allowed min-w-[4rem]"
            >
              {isGenerating ? (
